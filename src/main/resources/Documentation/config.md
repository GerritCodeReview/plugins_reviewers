...
:	Provide the configured reviewers as suggestions in the "Add Reviewer" dialog
	instead of automatically adding them to the change. Defaults to false. The
	weighting of the suggestions can be configured in the `[addreviewer]` section
	of `gerrit.config`. If this is not set, it defaults to 1.
