...
public class Module extends FactoryModule {
  ...
  protected void configure() {
    ...
    DynamicSet.bind(binder(), MergeValidationListener.class).to(ReviewersConfigValidator.class);
    DynamicSet.bind(binder(), CommitValidationListener.class).to(ReviewersConfigValidator.class);
    if (suggestOnly) {
      install(
          new AbstractModule() {
            @Override
