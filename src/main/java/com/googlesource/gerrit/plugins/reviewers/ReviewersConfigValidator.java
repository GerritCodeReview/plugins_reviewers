...
public class ReviewersConfigValidator implements MergeValidationListener, CommitValidationListener {
  ...
  private static String MALFORMED_FILTERS = "Malformed reviewers.config filters: ";
  ...
  @Inject
  public ReviewersConfigValidator(ForProject.Factory forProjectFactory) {
  ...
  private static String formatValidationErrors(List<ValidationError> errors) {
    ...
    errorMessage.append("]");
    return MALFORMED_FILTERS + errorMessage.toString();
  }
}
