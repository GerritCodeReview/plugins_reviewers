...
public class ReviewersScreen extends HorizontalPanel {
    ...
    for (ReviewerFilterSection section : Natives.asList(sections)) {
      ...
      editBtn.addClickHandler(new ClickHandler() {
        ...
        public void onClick(ClickEvent event) {
          ...
          InputElement reviewersInput = (InputElement) Document.get()
              .getElementById("reviewerInputField");
          InputElement excludedPathInput = (InputElement) Document.get()
              .getElementById("excludedInputField");
          InputElement originFilter = (InputElement) Document.get()
              .getElementById("originFilterInputField");
      ...
      removeFilterBtn.addClickHandler(new ClickHandler() {
        ...
        public void onClick(ClickEvent event) {
          ...
          boolean confirm =
              Window.confirm("Are you sure to remove that filter");
          if (confirm) {
    ...
    removeButton.addClickHandler(
        new ClickHandler() {
          ...
          public void onClick(final ClickEvent event) {
            boolean confirm =
                Window.confirm("Are you sure to remove reviewer: " + e.reviewer);
            if (confirm) {
  ...
  Panel createInputPanel() {
    // TODO: MDU: CHECK: Grid inputGrid = new Grid(2, 2);
    ...
    final SuggestBox filterBox =
        new SuggestBox(oracle, new AutoCompleteTextBox());
    ...
    excludedBox.getElement().setPropertyString("placeholder",
        "e.g. /lib/gen-src, /gen-src");
    ...
    addButton.addClickHandler(
        new ClickHandler() {
          ...
          public void onClick(final ClickEvent event) {
            /*
             * TODO Since we override getText() method in the AutoCompleteTexBox we
             * have to get value directly from the element propertie This[1]
            ...
            ReviewerEntry e = new ReviewerEntry(filter, reviewerBox.getValue(),
                excludedBox.getValue(), originFilterValue);
